...
class AppLocalizations {
  ...
  String get profileGuestSubtitle => _t('profileGuestSubtitle');
  String get profileLogin => _t('profileLogin');
  String get profilePosts => _t('profilePosts');
  String get profileFollowing => _t('profileFollowing');
  String get profileFollowers => _t('profileFollowers');
  String get profileFavorites => _t('profileFavorites');
  String get profileBuilds => _t('profileBuilds');
  String get profilePrompts => _t('profilePrompts');
  String get profileAccountTitle => _t('profileAccountTitle');
  String get profileAccountSubtitle => _t('profileAccountSubtitle');
  String get profileManage => _t('profileManage');
  String get profileEditTitle => _t('profileEditTitle');
  String get profileEditSubtitle => _t('profileEditSubtitle');
  String get profilePasswordTitle => _t('profilePasswordTitle');
  String get profilePasswordSubtitle => _t('profilePasswordSubtitle');
  String get profileLogout => _t('profileLogout');
  String get profileNoSignature => _t('profileNoSignature');
  String get profileSignature => _t('profileSignature');
  String get profileSignatureHint => _t('profileSignatureHint');
  String get profileSocialLinks => _t('profileSocialLinks');
  String get profileNoSocialLinks => _t('profileNoSocialLinks');
  String get profileSocialLinksHint => _t('profileSocialLinksHint');
  String get profileLinkFailed => _t('profileLinkFailed');
  String get profileMySchemes => _t('profileMySchemes');
  String get profileBuildSchemes => _t('profileBuildSchemes');
  String get profileTierSchemes => _t('profileTierSchemes');
  String get profileBpSchemes => _t('profileBpSchemes');
  String get profilePromptSchemes => _t('profilePromptSchemes');
