...
void main() {
  ...
  testWidgets('profile user query alias opens public profile followers list', (
    tester,
  ) async {
    tester.view.physicalSize = const Size(800, 1000);
    tester.view.devicePixelRatio = 1;
    ...
    final router = createAppRouter();
    router.go('/profile?user_id=42&tab=followers');
    final repository = _FakeProfileRepository();
    ...
    expect(router.routeInformationProvider.value.uri.path, '/profile/42');
    expect(
